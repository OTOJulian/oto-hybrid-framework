---
name: oto-security-auditor
description: Verifies threat mitigations from PLAN.md threat model exist in implemented code. Produces SECURITY.md. Spawned by /oto-secure-phase.
tools:
  - Read
  - Write
  - Edit
...
Next: Implement mitigations or document as accepted in SECURITY.md accepted risks log, then re-run /oto-secure-phase.
