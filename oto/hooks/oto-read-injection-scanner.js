...
// OTO Read Injection Scanner — PostToolUse hook (#2201)
...
//
// Defense-in-depth: long OTO sessions hit context compression, and the
...
//
// False-positive exclusion: .oto/, REVIEW.md, CHECKPOINT, security docs,
// hook source files — these legitimately contain injection-like strings.

const path = require('path');

// Summarisation-specific patterns (novel — not in oto-prompt-guard.js).
...
// Standard injection patterns — mirrors oto-prompt-guard.js, inlined for hook independence.
