...
<execution_context>
@~/.claude/oto/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.claude/oto/workflows/session-report.md end-to-end.
</process>
