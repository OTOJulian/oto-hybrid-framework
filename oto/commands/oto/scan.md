---
name: oto:scan
description: Rapid codebase assessment — lightweight alternative to /oto-map-codebase
allowed-tools:
  - Read
  - Write
  - Bash
...
<execution_context>
@~/.claude/oto/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @~/.claude/oto/workflows/scan.md end-to-end.
</process>
