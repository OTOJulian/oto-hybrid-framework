...
Read and execute `~/.claude/oto/workflows/discuss-phase-assumptions.md` end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value):
Read and execute `~/.claude/oto/workflows/discuss-phase.md` end-to-end.
