---
name: oto:next
description: Automatically advance to the next logical step in the OTO workflow
allowed-tools:
  - Read
  - Bash
  - Grep
...
---
<objective>
Detect the current project state and automatically invoke the next logical OTO workflow step.
...
<execution_context>
@~/.claude/oto/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @~/.claude/oto/workflows/next.md end-to-end.
</process>
