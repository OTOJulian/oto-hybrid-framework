...
<execution_context>
@~/.claude/oto/workflows/spec-phase.md
@~/.claude/oto/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @~/.claude/oto/workflows/spec-phase.md end-to-end.
...
- User knows they can now run /oto-discuss-phase which will load SPEC.md automatically
</success_criteria>
