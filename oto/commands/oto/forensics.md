...
type: prompt
name: oto:forensics
description: Post-mortem investigation for failed OTO workflows — analyzes git history, artifacts, and state to diagnose what went wrong
...
<execution_context>
@~/.claude/oto/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @~/.claude/oto/workflows/forensics.md end-to-end.
</process>
