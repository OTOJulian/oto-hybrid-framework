...
Template for `.oto/phases/XX-name/DISCOVERY.md` - shallow research for library/option decisions.

**Purpose:** Answer "which library/option should we use" questions during mandatory discovery in plan-phase.

For deep ecosystem research ("how do experts build this"), use `/oto-research-phase` which produces RESEARCH.md.
...
<output_structure>
Create `.oto/phases/XX-name/DISCOVERY.md`:
...
- Use `/oto-research-phase` for these
</guidelines>
