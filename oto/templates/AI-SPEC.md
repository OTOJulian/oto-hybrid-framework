...
> AI design contract generated by `/oto-ai-integration-phase`. Consumed by `oto-planner` and future eval tooling.
...
> Researched by `oto-domain-researcher`. Grounds the evaluation strategy in domain expert knowledge.
