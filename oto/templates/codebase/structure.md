...
Template for `.oto/codebase/STRUCTURE.md` - captures physical file organization.
...
**oto/templates/**
- Purpose: Document templates for .oto/ files
...
**New Slash Command:**
- Primary code: `commands/oto/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `oto/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `oto/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/oto/workflows/{name}.md`

**New Reference Document:**
- Implementation: `oto/references/{name}.md`
