...
Template for `.oto/codebase/ARCHITECTURE.md` - captures conceptual code organization.
...
**State Management:**
- File-based: All state lives in `.oto/` directory
...
- Triggers: User runs `oto <command>`
