...
> **Note:** Planning methodology is in `agents/oto-planner.md`.
> This template defines the PLAN.md output format that the agent produces.

Template for `.oto/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
<!-- For checkpoint task examples and patterns, see @~/.claude/oto/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/oto-plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
```markdown
<context>
@.oto/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@.oto/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
See `~/.claude/oto/references/tdd.md` for TDD plan structure.
...
<output>
After completion, create `.oto/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@.oto/PROJECT.md
@.oto/ROADMAP.md
@.oto/phases/03-features/03-01-SUMMARY.md
@.oto/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `.oto/phases/03-features/03-03-SUMMARY.md`
</output>
```
...
See `~/.claude/oto/templates/user-setup.md` for full schema and examples
...
See `~/.claude/oto/workflows/verify-phase.md` for verification logic.
