...
Template for `.oto/phases/XX-name/{phase_num}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /oto-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /oto-plan-phase --gaps with root causes
...
**Creation:** When /oto-verify-work starts new session
...
- `/oto-verify-work {phase}` picks up from first pending/blocked test
