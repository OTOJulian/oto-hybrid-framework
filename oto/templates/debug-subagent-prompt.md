...
Template for spawning oto-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="oto-debugger", description="Debug UAT-001")
```
