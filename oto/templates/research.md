...
Template for `.oto/phases/XX-name/{phase_num}-RESEARCH.md` - comprehensive ecosystem research before planning.
...
**CRITICAL:** If CONTEXT.md exists from /oto-discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches OTO templates)
...
**After creation:**
- File lives in phase directory: `.oto/phases/XX-name/{phase_num}-RESEARCH.md`
