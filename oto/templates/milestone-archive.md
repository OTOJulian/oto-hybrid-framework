...
This template is used by the complete-milestone workflow to create archive files in `.oto/milestones/`.
...
_For current project status, see .oto/ROADMAP.md_
...
- Save to `.oto/milestones/v{VERSION}-{NAME}.md`
- Example: `.oto/milestones/v1.0-mvp.md`
