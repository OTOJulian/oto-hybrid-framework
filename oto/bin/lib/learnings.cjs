 ...
 *
 * Provides a cross-project learnings store at ~/.oto/knowledge/.
...
const DEFAULT_STORE_DIR = path.join(os.homedir(), '.oto', 'knowledge');
 ...
 *   More content...
 *
 * @param {string} planningDir - Path to .oto/ directory (or directory containing LEARNINGS.md)
 * @param {object} [opts]
 * @param {string} [opts.storeDir] - Override store directory
...
/**
 * Handle `oto-tools learnings list`
...
/**
 * Handle `oto-tools learnings query --tag <tag>`
 * @param {string} tag
 * @param {boolean} raw - Raw output flag
 */
...
/**
 * Handle `oto-tools learnings copy`
...
/**
 * Handle `oto-tools learnings prune --older-than <duration>`
...
/**
 * Handle `oto-tools learnings delete <id>`
 * @param {string} id
 * @param {boolean} raw - Raw output flag
 */
