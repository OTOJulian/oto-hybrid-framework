 ...
 *
 * Scans all .oto/ artifact categories for items with open/unresolved state.
 * Returns structured JSON for workflow consumption.
 * Called by: oto-tools.cjs audit-open
 * Used by: /oto-complete-milestone pre-close gate
 */
...
/**
 * Scan .oto/debug/ for open sessions.
...
/**
 * Scan .oto/quick/ for incomplete tasks.
...
/**
 * Scan .oto/threads/ for open threads.
...
/**
 * Scan .oto/todos/pending/ for pending todos.
...
/**
 * Scan .oto/seeds/SEED-*.md for unimplemented seeds.
...
/**
 * Scan .oto/phases for UAT gaps (UAT files with status != 'complete').
 */
...
/**
 * Scan .oto/phases for VERIFICATION gaps.
 */
...
/**
 * Scan .oto/phases for CONTEXT files with open_questions.
 */
...
/**
 * Main audit function. Scans all .oto/ artifact categories.
 *
