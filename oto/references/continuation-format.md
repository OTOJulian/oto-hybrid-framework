...
- `/oto-list-phase-assumptions 2` — check assumptions
...
**Also available:**
- `/oto-discuss-phase 2` — gather context first
- `/oto-research-phase 2` — investigate unknowns
- Review roadmap
...
**Also available:**
- `/oto-discuss-phase 3` — gather context first
- `/oto-research-phase 3` — investigate unknowns
...
**To plan directly:** `/oto-plan-phase 3`

**To discuss context first:** `/oto-discuss-phase 3`

**To research unknowns:** `/oto-research-phase 3`
