...
Completion markers and handoff schemas for all OTO agents. Workflows use these markers to detect agent completion and route accordingly.
...
|-------|------|--------------------|
| oto-planner | Plan creation | `## PLANNING COMPLETE` |
| oto-executor | Plan execution | `## PLAN COMPLETE`, `## CHECKPOINT REACHED` |
| oto-phase-researcher | Phase-scoped research | `## RESEARCH COMPLETE`, `## RESEARCH BLOCKED` |
| oto-project-researcher | Project-wide research | `## RESEARCH COMPLETE`, `## RESEARCH BLOCKED` |
| oto-plan-checker | Plan validation | `## VERIFICATION PASSED`, `## ISSUES FOUND` |
| oto-research-synthesizer | Multi-research synthesis | `## SYNTHESIS COMPLETE`, `## SYNTHESIS BLOCKED` |
| oto-debugger | Debug investigation | `## DEBUG COMPLETE`, `## ROOT CAUSE FOUND`, `## CHECKPOINT REACHED` |
| oto-roadmapper | Roadmap creation/revision | `## ROADMAP CREATED`, `## ROADMAP REVISED`, `## ROADMAP BLOCKED` |
| oto-ui-auditor | UI review | `## UI REVIEW COMPLETE` |
| oto-ui-checker | UI validation | `## ISSUES FOUND` |
| oto-ui-researcher | UI spec creation | `## UI-SPEC COMPLETE`, `## UI-SPEC BLOCKED` |
| oto-verifier | Post-execution verification | `## Verification Complete` (title case) |
| oto-integration-checker | Cross-phase integration check | `## Integration Check Complete` (title case) |
| oto-nyquist-auditor | Sampling audit | `## PARTIAL`, `## ESCALATE` (non-standard) |
...
2. **Title-case markers** (e.g., `## Verification Complete`) exist in oto-verifier and oto-integration-checker -- these are intentional as-is, not bugs
...
> **NOTE:** `## PLAN COMPLETE` is the oto-executor's completion marker but execute-phase.md does not regex-match it. Instead, it detects executor completion via spot-checks (SUMMARY.md existence, git commit state). This is intentional behavior, not a mismatch.
