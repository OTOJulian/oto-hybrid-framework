...
|----------|---------------|---------------|-------|
| plan-phase | oto-planner | oto-plan-checker | Revision prompt via planner-revision.md |
| execute-phase | oto-executor | oto-verifier | Post-execution verification |
| discuss-phase | orchestrator | oto-plan-checker | Inline revision by orchestrator |
