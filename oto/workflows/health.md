<purpose>
Validate `.oto/` directory integrity and report actionable issues. Checks for missing files, invalid configurations, inconsistent state, and orphaned plans. Optionally repairs auto-fixable issues.
</purpose>
...
```bash
oto-sdk query validate.health $REPAIR_FLAG $BACKFILL_FLAG
```
...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /oto-health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /oto-new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /oto-health --repair
```
</step>
...
```
Would you like to run /oto-health --repair to fix N issues automatically?
```
...
|------|----------|-------------|------------|
| E001 | error | .oto/ directory not found | No |
...
| W019 | warning | Unrecognized .oto/ root file — not a canonical OTO artifact | No |
...
| backfillMilestones | Synthesize missing MILESTONES.md entries from `.oto/milestones/vX.Y-ROADMAP.md` snapshots | None — additive only; triggered by `--backfill` flag |
