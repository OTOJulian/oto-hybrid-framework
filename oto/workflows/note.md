...
4. **Requires `.planning/` directory** — if it doesn't exist, warn: "Todos require a OTO project. Run `/oto-new-project` to initialize one."
...
3. **Promote without project**: Warns that todos require `.planning/`, suggests `/oto-new-project`
