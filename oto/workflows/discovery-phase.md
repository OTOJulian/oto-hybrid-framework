...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /oto-research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/oto/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/oto/templates/discovery.md structure:
...
**Output:** `.oto/phases/XX-name/DISCOVERY.md`
</step>
...
1. **Scope the discovery** using ~/.claude/oto/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/oto/templates/discovery.md
...
**Output:** `.oto/phases/XX-name/DISCOVERY.md` (comprehensive)
</step>
...
Use ~/.claude/oto/templates/discovery.md.
...
Write `.oto/phases/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: .oto/phases/XX-name/DISCOVERY.md
Recommendation: [one-liner]
Confidence: [level]

What's next?

1. Discuss phase context (/oto-discuss-phase [current-phase])
2. Create phase plan (/oto-plan-phase [current-phase])
