<purpose>
Retroactive audit of an implemented AI phase's evaluation coverage. Standalone command that works on any OTO-managed AI phase. Produces a scored EVAL-REVIEW.md with gap analysis and remediation plan.

Use after /oto-execute-phase to verify that the evaluation strategy from AI-SPEC.md was actually implemented. Mirrors the pattern of /oto-ui-review and /oto-validate-phase.
</purpose>
...
```bash
INIT=$(oto-sdk query init.phase-op "${PHASE_ARG}" 2>/dev/null || echo "")
...
```bash
AUDITOR_MODEL=$(oto-sdk query resolve-model oto-eval-auditor 2>/dev/null | jq -r '.model' 2>/dev/null || true)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 OTO ► EVAL AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**State C** — No SUMMARY.md: Exit — "Phase {N} not executed. Run /oto-execute-phase {N} first."
...
Consider running /oto-ai-integration-phase {N} before implementation next time.
```
...
```markdown
Read ~/.claude/agents/oto-eval-auditor.md for instructions.
...
Read the orchestrator-written EVAL-REVIEW.md. Extract:
- `overall_score`
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 OTO ► EVAL AUDIT COMPLETE — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
{If PRODUCTION READY:}
  Next step: /oto-plan-phase (next phase) or deploy

{If NEEDS WORK:}
  Address critical gaps in EVAL-REVIEW.md, then re-run /oto-eval-review {N}
...
- [ ] oto-eval-auditor spawned with correct context
- [ ] EVAL-REVIEW.md returned by auditor and written by the orchestrator
