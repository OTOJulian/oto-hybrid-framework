...
AUDIT_PATH=".oto/milestones/v${VERSION}-MILESTONE-AUDIT.md"
```
...
RETRO_PATH=".oto/RETROSPECTIVE.md"
...
```bash
oto-sdk query commit "docs(v${VERSION}): generate milestone summary for onboarding" --files \
  ".oto/reports/MILESTONE_SUMMARY-v${VERSION}.md"
```
...
If the user is done:
- Suggest next steps: `/oto-new-milestone`, `/oto-progress`, or sharing the summary with the team
