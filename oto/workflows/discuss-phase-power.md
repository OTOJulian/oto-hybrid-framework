...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/oto-discuss-phase`.
...
Consider running /oto-discuss-phase {N} again to refine before planning.
```
