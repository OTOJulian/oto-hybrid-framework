...
```bash
oto-sdk query commit "docs: ingest {N} docs from {SCAN_PATH} (#2387)" --files \
  .oto/PROJECT.md \
  .oto/REQUIREMENTS.md \
  .oto/ROADMAP.md \
  .oto/STATE.md \
