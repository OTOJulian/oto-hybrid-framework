<purpose>
Retroactive 6-pillar visual audit of implemented frontend code. Standalone command that works on any project — OTO-managed or not. Produces scored UI-REVIEW.md with actionable findings.
</purpose>
...
AGENT_SKILLS_UI_REVIEWER=$(oto-sdk query agent-skills oto-ui-auditor)
```

Parse: `phase_dir`, `phase_number`, `phase_name`, `phase_slug`, `padded_phase`, `commit_docs`.

```bash
UI_AUDITOR_MODEL=$(oto-sdk query resolve-model oto-ui-auditor --raw)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 OTO ► UI AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**If `SUMMARY_FILES` empty:** Exit — "Phase {N} not executed. Run /oto-execute-phase {N} first."
...
```markdown
Read ~/.claude/agents/oto-ui-auditor.md for instructions.
...
- `/oto-verify-work {N}` — UAT testing
- `/oto-plan-phase {N+1}` — plan next phase
...
```bash
oto-sdk query commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
...
- [ ] oto-ui-auditor spawned with correct context
