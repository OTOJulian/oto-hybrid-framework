...
@~/.claude/oto/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@~/.claude/oto/references/ios-scaffold.md
...
@~/.claude/oto/references/executor-examples.md
</deviation_rules>
...
**See @~/.claude/oto/references/checkpoints.md**
...
**Use template:** @~/.claude/oto/templates/summary.md
