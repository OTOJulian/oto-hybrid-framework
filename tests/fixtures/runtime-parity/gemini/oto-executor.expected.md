...
@~/.gemini/oto/references/mandatory-initial-read.md
</role>
...
**Project skills:** @~/.gemini/oto/references/project-skills-discovery.md
...
@~/.gemini/oto/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@~/.gemini/oto/references/ios-scaffold.md
...
@~/.gemini/oto/references/executor-examples.md
</deviation_rules>
...
**See @~/.gemini/oto/references/checkpoints.md**
...
**Use template:** @~/.gemini/oto/templates/summary.md
