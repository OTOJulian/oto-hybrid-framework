...
- ✅ **v0.5.0 Exa Search Integration** — Phases 14-16 (shipped 2026-07-18)
- 📋 **Next milestone** — not yet defined (run `/oto-new-milestone`)

## Phases

**Phase Numbering:**
- Integer phases: planned milestone work — numbering continues above the highest existing phase folder (currently 16). Existing phase directories are never renamed, moved, or deleted.
- Decimal phases (e.g., 14.1): urgent insertions (marked with INSERTED)

<details>
<summary>✅ v0.5.0 Exa Search Integration (Phases 14-16) — SHIPPED 2026-07-18</summary>

- [x] Phase 14: Key Storage Reconciliation (19/19 plans) — completed 2026-07-13
- [x] Phase 15: Exa MCP Registration (All Three Runtimes) (12/12 plans) — completed 2026-07-14
- [x] Phase 16: Agent Guidance + Hardening (9/9 plans) — completed 2026-07-18
