...
- [x] **SECR-04**: User can set, replace, and clear integration API keys via `/oto-settings-integrations`; keys are written to the keyfile via stdin (never argv), and status displays are masked (`****<last-4>`)
